...
export interface components {
    ...
    parameters: {
        ...
        /**
         * @description Number of columns to generate. Defaults to 10 when omitted. Valid
         *     range is 5..15 inclusive; values outside that range — or
         *     non-integers — produce a 400 with problem type
         *     `https://bliss.example/errors/invalid-puzzle-dimensions`. The
         *     bounds keep the CSP solver's vocabulary needs and per-request time
         *     budget reasonable.
         */
        PuzzleWidth: number;
        /**
         * @description Number of rows to generate. Defaults to 10 when omitted. Valid
         *     range is 5..15 inclusive; values outside that range — or
         *     non-integers — produce a 400 with problem type
...
export interface operations {
    getPuzzle: {
        ...
        responses: {
             ...
             *     grid (the daily default) chosen to keep
