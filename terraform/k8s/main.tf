...
#
# DELIBERATELY EMPTY of resources. This file documents the contract; the
# concrete cloud resources live in provider-specific implementations under
# `terraform/k8s/providers/<name>/` (planned, none committed yet).
#
# The contract:
#
...
#
# Provider implementations land in follow-up PRs:
#   - providers/hetzner/   — first implementation (PR3, ADR-0009 §default)
